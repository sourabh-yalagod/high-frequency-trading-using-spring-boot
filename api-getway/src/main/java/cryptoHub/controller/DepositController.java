...
public class DepositController {
    ...
    public ResponseEntity<String> createSessionForDeposit(@RequestBody DepositRequestDto payload) throws StripeException {
        ...
        SessionCreateParams params = SessionCreateParams.builder()
                ...
                .setSuccessUrl(FRONTEND_BASE_URL + "/deposit/" + payload.getUserId()
                        + "?status=success&session_id={CHECKOUT_SESSION_ID}")
                .setCancelUrl(FRONTEND_BASE_URL + "/deposit/" + payload.getUserId()
                        + "?status=failed&session_id={CHECKOUT_SESSION_ID}")
                .addLineItem(
